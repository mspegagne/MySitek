...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => 'Le fichier envoyé depasse la limite autorisée par le serveur',
        2 => 'Le fichier envoyé depasse la limite autorisée par le formulaire',
        3 => 'Le fichier a été partiellement envoyé',
        4 => 'Aucun fichier n\' a été envoyé',
        6 => 'Dossier temporaire manquant',
        7 => 'Impossible d\'écrire le fichier sur le serveur',
        8 => 'Une extension php a stoppé l\'envoi',
        'post_max_size' => 'Le fichier envoyé depasse la limite autorisée par le serveur',
        'max_file_size' => 'Le fichier est trop gros',
        'min_file_size' => 'Le fichier est trop léger',
        'accept_file_types' => 'Fichier non autorisé',
        'max_number_of_files' => 'Limite de fichiers dépassée',
        'max_width' => 'L\'image dépasse la largeur maximum autorisée',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'readfile_chunk_size' => 3 * 1024 * 1024, // 10 MiB
